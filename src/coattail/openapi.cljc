...
(defn core-schema->operator
  ...
  (let [;; schema items
        ...
        format-default (if (some? data-default)
                         (format-parser data-default)
                         (get-in *openapi-toolbox* [:core-types data-type :format data-format :default]))
        ;; other items
...
(defn schema->default
  ([openapi-schema openapi-document]
    (schema->default openapi-schema openapi-document {}))
  ([openapi-schema openapi-document {:keys [data-name openapi-toolbox]
    ...
    (i/assert-openapi-schema   openapi-schema)
    (schema->operator :default data-name openapi-schema openapi-document openapi-toolbox)))
